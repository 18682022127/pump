...
public class SimpleExecutor extends org.apache.ibatis.executor.SimpleExecutor implements IJndiExecutor {

    private IJndi jndi;

    public SimpleExecutor(Configuration configuration, Transaction transaction, IJndi jndi) {
