...
public abstract class XMLUtilsImpl {

    private static final XMLUtilsImpl instance = new XMLUtilsImpl() {};

    private XMLUtilsImpl() {}
    ...
    public Object fromXML(String xml, Class objClass) {
