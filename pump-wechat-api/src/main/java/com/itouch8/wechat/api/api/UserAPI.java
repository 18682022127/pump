...
import com.itouch8.wechat.api.bean.user.FollowResult;
import com.itouch8.wechat.api.bean.user.GetblacklistResult;
import com.itouch8.wechat.api.bean.user.Group;
import com.itouch8.wechat.api.bean.user.TagsCreatResult;
import com.itouch8.wechat.api.bean.user.TagsGetResult;
import com.itouch8.wechat.api.bean.user.TagsGetidlistResult;
import com.itouch8.wechat.api.bean.user.User;
import com.itouch8.wechat.api.bean.user.UserInfoList;
import com.itouch8.wechat.api.bean.user.UserTagGetResult;
import com.itouch8.wechat.api.client.LocalHttpClient;
import com.itouch8.wechat.api.util.EmojiUtil;
