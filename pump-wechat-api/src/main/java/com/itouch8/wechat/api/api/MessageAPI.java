...
import com.itouch8.wechat.api.bean.media.Media;
import com.itouch8.wechat.api.bean.message.ApiAddTemplateResult;
import com.itouch8.wechat.api.bean.message.Article;
import com.itouch8.wechat.api.bean.message.CurrentAutoreplyInfo;
import com.itouch8.wechat.api.bean.message.GetAllPrivateTemplateResult;
import com.itouch8.wechat.api.bean.message.GetIndustryResult;
import com.itouch8.wechat.api.bean.message.MessageSendResult;
import com.itouch8.wechat.api.bean.message.Uploadvideo;
import com.itouch8.wechat.api.bean.message.massmessage.MassMessage;
import com.itouch8.wechat.api.bean.message.message.Message;
import com.itouch8.wechat.api.bean.message.preview.Preview;
import com.itouch8.wechat.api.bean.message.templatemessage.TemplateMessage;
import com.itouch8.wechat.api.bean.message.templatemessage.TemplateMessageResult;
import com.itouch8.wechat.api.bean.message.templatemessage.WxopenTemplateMessage;
