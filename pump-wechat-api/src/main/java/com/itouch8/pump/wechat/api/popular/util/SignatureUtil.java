package com.itouch8.pump.wechat.api.popular.util;
...
import com.itouch8.pump.wechat.api.popular.bean.pay.PayFeedback;
import com.itouch8.pump.wechat.api.popular.bean.pay.PayNativeInput;
import com.itouch8.pump.wechat.api.popular.bean.pay.PayNotify;
import com.itouch8.pump.wechat.api.popular.bean.pay.PayWarn;
import com.itouch8.pump.wechat.api.popular.bean.paymch.MchPayNotify;
import com.itouch8.pump.wechat.api.popular.bean.paymch.PapayEntrustwebNotify;
...
public class SignatureUtil {
    ...
    /**
     * 验证 mch pay notify sign 签名 使用更好的 SignatureUtil.validateSign
     * 
     * @param mchPayNotify
     * @param key mch key
     * @return
    ...
    /**
     * 验证代扣签约 签名 使用更好的 SignatureUtil.validateSign
     * 
